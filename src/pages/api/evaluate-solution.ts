...
import { documentationHandler } from '@/utils/problems/documentation/undocumented-module';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    try {
      ...
      console.error(`Error during ${taskType} handler execution:`, handlerError);
      evaluationResult = { passed: false, feedback: `An error occurred during evaluation: ${handlerError.message || 'Unknown error'}` };
    }
